...
Scope / 范围：mainland Chinese ordinary-passport holders applying from mainland China for an exact **visa-application** [reviewed route](global-online-route-screen.md), including UK, Canada, Australian Visitor 600 Tourist or Business Visitor, Schengen individual tourism, New Zealand Visitor, and selected tourist eVisas. Visa-free and standalone non-visa eTA routes are screening exits, not case-management modules. Codex performs research and evidence review online; the applicant performs any required lodging or identity step. The authority decides the application. Last reviewed: 2026-09-26.

## Route gate / 路由关卡

Ask for nationality and passport type, residence and application location, destination, exact purpose, intended dates, companions/minors, funding, previous immigration problems, and whether an interview has already been requested. First use the [global screen](global-online-route-screen.md) to classify visa-free, ETA, eVisa, full online visa, online-form-only, mandatory agency or unknown; choose exactly one applicable **visa** module. For visa-free or non-visa authorization, report the finding and exit rather than run nine application gates. Work, study, immigration, medical, marriage, transit, and sponsored-family visas need their own exact rules. Do not fit one into a tourist module.
...
| Australia Business Visitor | permitted unpaid visitor activity versus actual work, genuine visit, funding and return | offshore ImmiAccount and attachments; biometrics/health if requested | hands-on work, wrong stream, or formal interview |
...
| Kenya eTA | ordinary-passport exemption screen only | non-visa authorization; no visa case | exit this Skill after reporting the result |
| Cambodia waiver | date-and-duration visa-need screen only | no visa case for confirmed waiver; e-Arrival is separate | out-of-window Visa T remains unbuilt |
